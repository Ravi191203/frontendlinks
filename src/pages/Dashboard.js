  ...
  const [projects, setProjects] = useState([
    {
      ...
      url: "https://neural-dash.app",
      description: "AI-powered analytics dashboard with real-time insights and machine learning predictions",
      category: "AI/ML",
      status: "Live",
